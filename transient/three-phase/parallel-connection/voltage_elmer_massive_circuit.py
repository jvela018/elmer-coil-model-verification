...
def main(argv=None):
    ...
    # name output file
    output_file = "transient_2d_massive_voltage_source.definition"
 ...
 # ------------------ Circuit 1 (Current Source - Transient)---------------------
    ...
    # store components in array components = [comp1, comp2,...] - do not remove
    c[2].components.append([v2, terminal_2p])
    ...
    # massive coil positive terminal
    terminal_3p = ElmerComponent("T3p", 2, 1, 3, ["WIRE3"])

    # store components in array components = [comp1, comp2,...] - do not remove
    c[3].components.append([v3, terminal_3p])
